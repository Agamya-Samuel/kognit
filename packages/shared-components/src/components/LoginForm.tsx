...
import { Button, Input, Field, FieldGroup, FieldLabel, FieldSeparator, FieldDescription, cn } from '@edutech/ui';
import { loginSchema, type LoginInput } from '@edutech/validation';
      ...
      <div className={cn('flex flex-col gap-6', className)} ref={ref} {...props}>
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              {hasSocialLogin ? 'Login with your Apple or Google account' : 'Enter your email and password to login'}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)}>
              <FieldGroup>
                {hasSocialLogin && (
                  <Field>
                    {onAppleLogin && (
                      <Button type="button" variant="outline" onClick={onAppleLogin} className="w-full">
                  ...
                  <FieldDescription className="text-center">
                    {onSignUpClick ? (
                      <>
                        ...
                        <button type="button" onClick={onSignUpClick} className="underline-offset-4 hover:underline">
                          Sign up
                        </button>
                      </>
                    ) : (
